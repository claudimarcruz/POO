...
public class TelaMolho extends JFrame {
	...
	public TelaMolho() {
		...
		JLabel lblNewLabel = new JLabel("Novo Molho");
		...
		btnNewButton_molho = new JButton("Confirmar");
		btnNewButton_molho.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		btnNewButton_molho.setBounds(165, 300, 119, 23);
		panel_1.add(btnNewButton_molho);
	...
	public void setBotaoBehaviorMolho(ActionListener botaoBehaviorMolho) {
		btnNewButton_molho.addActionListener(botaoBehaviorMolho);
	}
