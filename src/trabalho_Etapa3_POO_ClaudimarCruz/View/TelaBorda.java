...
public class TelaBorda extends JFrame {
	...
	public TelaBorda() {
		...
		JLabel lblNewLabel = new JLabel("Nova Borda");
		...
		textField_nome.setBounds(183, 39, 126, 20);
		...
		textField_valor.setBounds(183, 64, 126, 20);
		panel_1.add(textField_valor);
		
		JLabel lblNewLabel_1_1_1 = new JLabel("Recheio");
		...
		textField_recheio.setBounds(183, 89, 126, 20);
	...
	public void setBotaoBehaviorBorda(ActionListener botaoBehaviorBorda) {
		btnNewButton_recheio.addActionListener(botaoBehaviorBorda);
	}
