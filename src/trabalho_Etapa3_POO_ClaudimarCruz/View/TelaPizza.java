...
public class TelaPizza extends JFrame {
	...
	@SuppressWarnings("rawtypes")
	static JComboBox comboBox_molho;
	@SuppressWarnings("rawtypes")
	static JComboBox comboBox_borda;
	@SuppressWarnings("rawtypes")
	static JComboBox comboBox_recheio1;
	@SuppressWarnings("rawtypes")
	static JComboBox comboBox_recheio2;
	...
	public TelaPizza() {
		...
		comboBox_molho.addItem("<Selecione>");
		comboBox_molho.addAncestorListener(new AncestorListener() {
		    public void ancestorAdded(AncestorEvent event) {
		    	try {
		            MolhoDAO molhoDAO = new MolhoDAO();
		            List<String> items = molhoDAO.selectCadastro();
		            for (String item : items) {
		            	
		                comboBox_molho.addItem(item);
		            }
		...
		comboBox_borda.addItem("<Selecione>");
		comboBox_borda.addAncestorListener(new AncestorListener() {
		    public void ancestorAdded(AncestorEvent event) {
		    	try {
		            BordaDAO bordaDAO = new BordaDAO();
		            List<String> items = bordaDAO.selectCadastro();
		            for (String item : items) {
		            	
		                comboBox_borda.addItem(item);
		            }
		...
		comboBox_recheio1.addItem("<Selecione>");
		comboBox_recheio1.addAncestorListener(new AncestorListener() {
		    public void ancestorAdded(AncestorEvent event) {
		    	try {
		            RecheioDAO recheioDAO = new RecheioDAO();
		            List<String> items = recheioDAO.selectCadastro();
		            for (String item : items) {
		            	
		            	comboBox_recheio1.addItem(item);
		            }
		...
		comboBox_recheio2.addItem("<Selecione>");
		comboBox_recheio2.addAncestorListener(new AncestorListener() {
		    public void ancestorAdded(AncestorEvent event) {
		    	try {
		            ...
		            List<String> items = recheioDAO.selectCadastro();
		            for (String item : items) {
		            	comboBox_recheio2.addItem(item);
		            }
