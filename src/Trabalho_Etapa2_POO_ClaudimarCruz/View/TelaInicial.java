...
public class TelaInicial {
	...
	private void initialize() {
		...
		JButton btnCliente_1_1 = new JButton("Pagamento");
		btnCliente_1_1.setForeground(new Color(253, 245, 230));
		btnCliente_1_1.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		btnCliente_1_1.setBackground(new Color(165, 42, 42));
		btnCliente_1_1.setBounds(747, 104, 128, 23);
		panel_1.add(btnCliente_1_1);
	}
