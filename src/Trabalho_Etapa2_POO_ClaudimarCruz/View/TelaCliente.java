...
public class TelaCliente extends JFrame {
	...
	public TelaCliente() {
		...
		JLabel lblNewLabel_1_1_1_1_1_1_1_1 = new JLabel("Data Nascimento");
		lblNewLabel_1_1_1_1_1_1_1_1.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		lblNewLabel_1_1_1_1_1_1_1_1.setBounds(44, 195, 119, 14);
		panel_1.add(lblNewLabel_1_1_1_1_1_1_1_1);
		
		textField_nasc = new JTextField();
		textField_nasc.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		textField_nasc.setColumns(10);
		textField_nasc.setBounds(183, 192, 126, 20);
		panel_1.add(textField_nasc);
		
		
	
		btnNewButton_cliente= new JButton("Confirmar");
		btnNewButton_cliente.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		btnNewButton_cliente.setBounds(165, 300, 119, 23);
		panel_1.add(btnNewButton_cliente);
	...
	public String getNasc() {
		return textField_nasc.getText();
	}
	
	public void setBotaoBehaviorCliente(ActionListener botaoBehaviorCliente) {
		btnNewButton_cliente.addActionListener(botaoBehaviorCliente);
	}
